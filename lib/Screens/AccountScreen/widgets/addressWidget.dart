...
import 'package:world_miral_cs_cart_multivendor_flutter_app/CustomWidgets/stateSpinner.dart';
...
class AddressWidget extends StatefulWidget {
  ...
  bool isNew;
  bool updateData;
   AddressWidget(this.selectedProfile, this.countryList,this.isNew, this.updateData,{super.key});
...
if(widget.isNew){
  ...
  profileNameController =
      TextEditingController(text: widget?.selectedProfile?.profileName ?? "");
  firstNameController =
      TextEditingController(text: widget?.selectedProfile?.bFirstname ?? "");
  lastNameController =
  ...
  Widget build(BuildContext context) {
    ...
    GlobalData.updateProfileRequest.bCountry=selectedBillingCountry?.countryCode;
      ...
      child: Column(
        ...
        children: [
            ...
            validator: (value) {
              if (value == null || value.toString().isEmpty) {
                return "${GenericMethods.getStringValue(
                    context, AppStringConstant.profileName)} ${GenericMethods.getStringValue(
          ...
          Visibility(
            ...
            child: ShippingAddressWidget(widget.selectedProfile,widget.countryList),
          ),
